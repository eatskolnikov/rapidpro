...
from temba.tests import MockRequestValidator, MockTwilioClient
...
class TwilioTypeTest(TembaTest):
    ...
    def test_claim(self):
        ...
        with patch("temba.tests.MockTwilioClient.MockPhoneNumbers.stream") as mock_numbers:
            mock_numbers.return_value = iter([MockTwilioClient.MockPhoneNumber("+12062345678")])

            with patch("temba.tests.MockTwilioClient.MockShortCodes.stream") as mock_short_codes:
        ...
        with patch("temba.tests.MockTwilioClient.MockPhoneNumbers.stream") as mock_numbers:
            ...
            with patch("temba.tests.MockTwilioClient.MockShortCodes.stream") as mock_short_codes:
                ...
                with patch("temba.tests.MockTwilioClient.MockPhoneNumbers.get") as mock_numbers_get:
        ...
        with patch("temba.tests.MockTwilioClient.MockPhoneNumbers.stream") as mock_numbers:
            ...
            with patch("temba.tests.MockTwilioClient.MockShortCodes.stream") as mock_short_codes:
                ...
                with patch("temba.tests.MockTwilioClient.MockShortCodes.get") as mock_short_codes_get:
        ...
        with self.settings(IS_PROD=True):
            with patch("temba.tests.MockTwilioClient.MockPhoneNumber.update") as mock_numbers:
                # our twilio channel removal should fail on bad auth
                mock_numbers.side_effect = TwilioRestException(
                    401, "http://twilio", msg="Authentication Failure"
                )
